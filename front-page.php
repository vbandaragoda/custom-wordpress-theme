		...
		<div class="container-lg shops mb-5">
			...
			<div id="carousel-example-generic" class="carousel slide ">
				...
				<ol class="carousel-indicators carousel-indicators-numbers">
					<button type="button" data-bs-target="#carousel-example-generic" data-bs-slide-to="0"
						class="active ">1
					</button>
					<button type="button" data-bs-target="#carousel-example-generic" data-bs-slide-to="1">2
					</button>
					<button type="button" data-bs-target="#carousel-example-generic" data-bs-slide-to="2">3
					</button>
				</ol>
					...
					<div class="carousel-item active">
						<section id="grid-1">
							<div class="row align-items-center d-flex justify-content-around">
								...
								<div
									class="col-sm-10 col-md-6 col-lg-3 d-flex align-items-center justify-content-around">
									<a href="/sampleshop" class="text-decoration-none">
										<div class="card border-0 shadow p-3 mb-5 bg-body-tertiary rounded"
											...
											<div class="card-body">
												<h5
													class="card-title text-center pb-2 mb-4 text-secondary border-bottom border-light">
													Sample Shop 1
												</h5>
